    ...
    <section class="form-body">
        <header class="form-header">
            ...
            <table width="100%" height="8%" style="border: 0;">
                <tr style="border: 0;">
                    <td style="border: 0;" >
                        <center><span class="sinhala-font" style="font-size:16px;"><b>පො.කො.ප. 2 ආකෘති පත්‍රය</b></span><br><span class="tamil-font" style="font-size:14px;"><b>படிவம் பஒச 2</b></span><br><span style="font-size:15px;"> <b>FORM PCA 2</b></span></center>
                    </td>
                </tr>
            </table>
            <br>
            ...
            <table width="100%" style="border:0;">
                ...
                <tr style="border:0;">
                    <td style="border:0;padding: 0; font-size: 14px;" class="tamil-font" align="center" >
            ...
            <table width="100%" style="border:0;">
                ...
                <tr style="border:0;">
                    <td style="border:0; padding: 0;">
                        <center>(To be submitted within 60 days of award of Contract)</center>
                    </td>
                </tr>
            </table>
            <br>
            ...
            <table width="100%" style="border: 0;">
                    ...
                    <tr style="border: 0;">
                        ...
                        <td width="26%" style="border: 0; padding: 0;" class="tamil-font">கேள்விப்பத்திரம் கிடைக்கப்பெற்ற விண்ணப்பதாரரின் பெயH</td>
                        <td width="70%" style="border: 0; padding: 0;"></td>
                    </tr>
                    <tr style="border: 0;">
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="8%" style="border: 0; padding: 0; "  class="tamil-font" >தேசிய இனம்</td>
                    <td width="88%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="54%" style="border: 0; padding: 0; "  class="tamil-font">விண்ணப்பதாரரின்இ இந்த ஒழுங்கு விதிகளின் கீழானஇ பதிவூச் சான்றிதழின் இலக்கம்</td>
                    <td width="42%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="38%" style="border: 0; padding: 0; "  class="tamil-font">கேள்விப்பத்திரம் வழங்குவதற்கு ஏற்றுக்கொள்ளப்பட்ட தொகை</td>
                    <td width="60%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="24%" style="border: 0; padding: 0; "  class="tamil-font">கேள்விப்பத்திரம் வழங்கப்பட்ட திகதி</td>
                    <td width="62%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="24%" style="border: 0; padding: 0;"  class="tamil-font">ஒப்பந்தத்தின் காலப்பகுதி :- இருந்து  </td>
                    <td width="36%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="45%" style="border: 0; padding: 0; "  class="tamil-font">ஒப்பந்தம் எவரால் அளிக்கப்பட்டது</td>
                    <td width="51%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="84%" style="border: 0; padding: 0;"  class="tamil-font">ஒப்பந்தத்தின் தன்மை (ஒப்பந்தம் பற்றிய சுருக்கமான விவரணத்தை தருவதுடன் அதன் அத்தாட்சிப்படுத்தப்பட்ட ஒரு பிரதியையூம் இணைக்கவூம்)</td>
                    <td width="16%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="30%" style="border: 0; padding: 0; "  class="tamil-font">விண்ணப்பதாரரின் வருமான வரிக் கோவை இலக்கம்</td>
                    <td width="66%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="40%" style="border: 0; padding: 0; "  class="tamil-font">விண்ணப்பதாரரின்  பெ. சே. வ. (பெறுமானம் சேH வரி) கோவை இலக்கம்</td>
                    <td width="56%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0; ">
                    <td width="2%" style="border: 0; padding: 0;"></td>
                    <td width="73%" style="border: 0; padding: 0;"  class="tamil-font">ஒப்பந்தம் அளிக்கப்படுவதற்கு உடன் முன்னான 3 ஆண்டுகளுக்கு விண்ணப்பதாரராற் செலுத்தப்பட்ட வரித் தொகை   		</td>
                    <td width="23%" style="border: 0; padding: 0;"></td>
                </tr>
                <tr style="border: 0;">
                    <td width="2%" style="border: 0; padding: 0;"></td>
            ...
            <!-- <table width="100%" style="border: 0;">
                <tr style="border: 0;">
                    ...
                    <td width="22%" style="border: 0; padding: 0;">
                        <center><span class="sinhala-font">3 අවුරුද්ද</span><br><span  class="tamil-font">பெயர்</span><br>3rd year</center>
                    </td>
                    <td width="22%" style="border: 0; padding: 0;">
                        <center><span class="sinhala-font">2 අවුරුද්ද</span><br><span>  class="tamil-font"பெயர்</span><br>2nd year</center>
                    </td>
                ...
                <tr>
                    <td width="27%" style="border: 0; padding: 0;">
                        <table style="border: 0;">
                            ...
                            <tr style="border: 0; ">
                                <td width="20%" style="border: 0;padding: 0;">(i)</td>
                                <td width="45%" style="border: 0; padding: 0;" class="tamil-font">dhgrhtj</td>
                            </tr>
                            <tr style="border: 0; ">
                                <td width="20%" style="border: 0;padding: 0;">(i)</td>
                                <td width="45%" style="border: 0;padding: 0; ">Income Tax</td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td width="27%" style="border: 0; padding: 0;">
                        <table style="border: 0;">
                            ...
                            <tr style="border: 0; ">
                                <td width="20%" style="border: 0;padding: 0;">(ii)</td>
                                <td width="79%" style="border: 0; padding: 0;"  class="tamil-font">dhgrhtj</td>
                            </tr>
                            <tr style="border: 0; ">
                                <td width="20%" style="border: 0;padding: 0;">(ii)</td>
                                <td width="79%" style="border: 0;padding: 0; ">V.A.T.</td>
                            </tr>
                        </table>
                    </td>
                    <td width="22%" style="border: 0; padding: 0;"></td>
            ...
            <table width="100%" style="border: 0;">
                ...
                <tr style="border: 0;">
                    <td width="3%" style="border: 0; padding: 0;">(i)</td>
                    <td width="15%" style="border: 0; padding: 0;" class="tamil-font">னாபசாவத</td>
                ...
                <tr style="border: 0;">
                    <td width="3%" style="border: 0; padding: 0;">(ii)</td>
                    <td width="15%" style="border: 0; padding: 0;" >பெ. சே. வ.	</td>
                    <!-- <td width="15%" style="border: 0; padding: 0;">&#125;</td> -->
                    <td width="22%" style="border: 0; padding: 0;" ></td>
                    <td width="22%" style="border: 0; padding: 0;"></td>
                    <td width="24%" style="border: 0; padding: 0;"></td>
            ...
            <table style="border: 0; ">
                <tr style="border: 0; ">
                    <td style="border: 0; text-indent: 20;" class="sinhala-font">ඉහත සඳහන් කරන ලද විස්තර මගේ දැනීමේ හැටියට සත්‍ය හා නිවැරදි බවට මම මෙයින්
                        දිවුරා/ ගෞරව
                        බහුමානයෙන් අවංකව හා නොපැකිලව ප්‍රතිඥා දී ප්‍රකාශ කර සිටිමි.</td>
                </tr>
                <tr style="border: 0; ">
                    <td style="border: 0; " class="tamil-font">மேலே குறிப்பிடப்பெற்றுள்ள விபரங்கள் எமது அறிவூக்கு எட்டிய அளவில் உண்மையானவையூம் செம்மையானவையூம் என நான் இத்தால் சத்தியம் செய்கிறேன். பயபக்தியாகவூம் இ விசுவாசமாகவூம் மெய்யாகவூம் வெளிப்படுத்தி உறுதிப்படுத்துகிறேன்.	</td>
                </tr>
                <tr style="border: 0; ">
                    <td style="border: 0; text-indent: 20; ">I hereby swear/solemnly, sincerely and truly, declare and affirm that the
                        particulars stated
                        above are to the best of my knowledge true and accurate. </td>
                </tr>
            </table>
            <br>
            ...
            <table width="100%" style="border: 0; ">
                ...
                <tr style="border: 0; " height="80">
                    <td width="64%" height="80" style="border: 0; "></td>
                    <td width="30%" height="80" style="border: 0;padding: 0;  "></td>
                </tr>
                ...
                <tr style="border: 0; ">
                    <td width="64%" style="border: 0; "></td>
                    <td width="30%" style="border: 0;padding: 0;">
                        <center><span class="sinhala-font">සාම විනිසුරු</span><br><span  class="tamil-font">சமாதான நீதவான்	</span><br>Justice of Peace/Commissioner of oaths.</center>
                    </td>
                </tr>
            </table>
            <br>
            ...
            <table style="border: 0;">
                ...
                <tr style="border: 0;">
                    <td style="border: 0; " class="tamil-font" >&nbsp;&nbsp;&nbsp;&nbsp;குறிப்பு:- இவ்வெளிப்படுத்துகைஇ தனியாளொருவரின் விடயத்தில் அவராலும் குழுமம் அல்லது கூட்டிணைப்புக் குழுவொன்றின் விடயத்தில் முறையே பங்காளருள் ஒருவரால் அல்லது பணிப்பாளரொருவரால் அல்லது செயலாளராலும் ஒப்பமிடப்படுதல் வெண்டும்.  </td>
                </tr>
                <tr>
