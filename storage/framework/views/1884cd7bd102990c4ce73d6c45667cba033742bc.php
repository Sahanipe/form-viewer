        ...
        <table width="100%" style="border:0; padding:0;">
            ...
            <table width="100%" height="30">
                <tbody>
                    ...
                    <tr height="20">
                        <td width="30%" class="bg-color">The address at which the accounting records or accounts and returns required under section 149(2)(a) are kept</td>
                        <td width="70%">
                        </td>
                    </tr>
                </tbody>
...
149(2)(a) have been kept at the abovementioned address
</div>
<br>
...
<table style="border: 0" width="100%" >
            ...
            <tbody>
                <tr  > 
                    ...
                    <td width="6%"  height="40" rowspan="4" class="a"><img width="20" height="80" src="<?php echo e(asset('/form-images/signature.png')); ?>" alt="signature"></td>
