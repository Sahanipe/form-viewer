...
PLACE OF BUSINESS ESTABLISHED IN SRI LANKA
                ...
                <tr>
                    <td colspan="4"  style="border:0; padding:0px; font-size:13px; padding-left:230px;">The Companies Act No.
                        7 of 2007 Pursuant to be Sec 489(b)</td>
                </tr>
            </table>
            <br>
            ...
            <table width="100%" autosize="1">
                <tbody>
                    <tr >
                        <td style="width: 2.13in" height="80" class="bg-color">Signature Full Name of Authorised Person</td>
                        <td  style="width: 4.96in" height="80">&nbsp;</td>
                    </tr>
                    <tr >
                        <td style="width: 2.13in" height="50" class="bg-color">Signature of Authorised Person</td>
                        <td  style="width: 4.96in" height="50">&nbsp;</td>
                    </tr>
                </tbody>
            </table>
            <br>
