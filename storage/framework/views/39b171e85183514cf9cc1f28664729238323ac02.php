...
<!-- <?php echo e($foo); ?> -->
    ...
    <table style="border: 1; padding:0" width="100%" autosize="1">
        ...
        <tr style="border: 0;" >
            ...
            <td height="40"  class="a" rowspan="3"  style="padding-left:10px; width:32pt;" >
                <img width="16px" height="80" src="<?php echo e(asset('/form-images/signature.png')); ?>" alt="signature"></td>
    ...
    <table width="100%" border="1" autosize="1">
        ...
        <tr>
            <td colspan="7" style="text-align: left; border:1px solid #fff; border-bottom:1px solid #000; word-break: break-all;">
                <h4 style="font-size:15px; text-align: left;"><u>INITIAL SHARE HOLDERS</u></h4>
                <span style="font-weight: 400; font-size: 14px; word-break: break-all;"> The following persons are the initial
        ...
        <tr>
            ...
            <td colspan="2" rowspan="2" style="width:194pt;"></td>
        ...
        <tr height="4cm">
            <td style="width:20pt; border-bottom:0; border-top:0;"></td>
            ...
            <td rowspan="2" class="a" style="width:30pt;">  <img width="20" height="80" src="<?php echo e(asset('/form-images/signature.png')); ?>" alt="signature"></td>
    ...
    <table width="100%" autosize="1">
        ...
        <tr height="4cm">
            <td style="border-bottom:0; border-top:0; width:20pt;"></td>
            <td height="50" class="bg-color" style="width:102pt;">NIC No/Passport & Country<span style="font-size:10px;">(if a
                            foreigner)</span>/ Company No<span style="font-size:10px;">(if a company)</span>
            </td>
            <td style="width:194pt;" colspan="2"></td>
            <td style="width:30pt;" rowspan="2" class="a">  <img width="20" height="80" src="<?php echo e(asset('/form-images/signature.png')); ?>" alt="signature"></td>
    ...
    <table width="100%" autosize="1">
        ...
        <tr>
            ...
            <td style="width:28pt;" height="80%" class="a"><img width="20" height="80" src="<?php echo e(asset('/form-images/signature.png')); ?>" alt="signature"></td>
    ...
    <table width="100%" autosize="1">
        ...
        <tr>
            ...
            <td style="width:41pt;" height="80%" class="a"><img width="20" height="80" src="<?php echo e(asset('/form-images/signature.png')); ?>" alt="signature"></td>
