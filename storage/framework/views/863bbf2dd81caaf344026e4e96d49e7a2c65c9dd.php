...
<section class="form-body">
        <header class="form-header">
            <table width="100%" style="border:0; padding:0;">
                <tr>
                    <td width="10%" style="border:0; padding:0px;" rowspan="3"><img width="100" height="100" src="<?php echo e(asset('/form-images/govlogo.jpg')); ?>" alt="gov_logo"></td>
                    ...
                    <td width="10%" style="border:0; padding:0px;" rowspan="3"> <img width="130" height="auto" src="<?php echo e(asset('/form-images/eroc.png')); ?>" alt="Logo EROC"></td>
                </tr>
                <tr>
