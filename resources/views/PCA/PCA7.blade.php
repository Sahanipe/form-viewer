        ...
        <section class="form-body">
            ...
            <table style="border: 0;">
                <tr style="border: 0;">
                    ...
                    <td width="80%" style="border: 0; padding:0;" class="sinhala-font">නිමකර ඇති වැඩ සදහා ලබාගෙන ඇති මුළු මුදල්</td>
                    <td style="border: 0; font-size:35px" rowspan="3">&#125;</td>
                </tr>
                <tr style="border: 0;">
                    <td width="5%"  style="border: 0;"></td>
                    <td width="80%" style="border: 0; padding:0;" class="tamil-font">பூரணமாக முடிக்கப்பெற்ற வேலைக்குப் பெற்றுக் கொண்ட மொத்தக் கொடுப்பனவூ</td>
                </tr>
                <tr style="border: 0;">
                    <td width="5%"  style="border: 0;"></td>
                    <td width="80%" style="border: 0; padding:0;">Total payment received for work completed</td>
                </tr>
            </table>
            <br>
                ...
                <tr style="border: 0;">
                    ...
                    <td width="95%"  style="border: 0; ">
                        <table width="95%"  style="border: 0; " >
                            ...
                            <tr  style="border: 0; ">
                                <td width="5%"  style="border: 0;padding:0; " align="right"></td>
                                <td width="95%"   style="border: 0; padding:0; padding-bottom:10px; ">The nature of such sub-contract:-</td>
                            </tr>
                        </table>
                        <table width="95%"  style="border: 0; " >
                            <tr  style="border: 0; ">
                            ...
                            <tr  style="border: 0; ">
                                <td width="5%"   style="border: 0; padding:0;"  align="right"></td>
                                <td width="95%"   style="border: 0;padding:0; padding-bottom:10px; ">The name of sub-contractor:-</td>
                            </tr>
                        </table>
                        <table width="95%"  style="border: 0; " >
                            <tr  style="border: 0; ">
                            ...
                            <tr  style="border: 0; ">
                                <td width="5%"   style="border: 0; padding:0;"  align="right"></td>
                                <td width="95%"   style="border: 0;padding:0; padding-bottom:10px; ">Address of sub – contractor :-</td>
                            </tr>
                        </table>
                        <table width="95%"  style="border: 0; " >
                            <tr  style="border: 0; ">
                            ...
                            <tr  style="border: 0; ">
                                <td width="5%"   style="border: 0; padding:0;"  align="right"></td>
                                <td width="95%"   style="border: 0;padding:0; padding-bottom:10px; ">Nationality of sub – contractor:-</td>
                            </tr>
                        </table>
                        <table width="95%"  style="border: 0; " >
                            <tr  style="border: 0; ">
                            ...
                            <tr  style="border: 0; ">
                                <td width="5%"   style="border: 0; padding:0;"  align="right"></td>
                                <td width="95%"   style="border: 0;padding:0; padding-bottom:10px; ">Total cost of sub – contract :-</td>
                            </tr>
                        </table>
                        <table width="95%"  style="border: 0; " >
                            <tr  style="border: 0; ">
                            ...
                            <tr  style="border: 0; ">
                                <td width="5%"   style="border: 0; padding:0;"  align="right"></td>
                                <td width="95%"   style="border: 0;padding:0; padding-bottom:10px; ">Duration of sub – contract :-</td>
                            </tr>
                        </table>
                    </td>
                </tr>
