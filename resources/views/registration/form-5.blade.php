...
<body>
    <section class="form-body">
        ...
        <!-- <div style="border:1px solid red; oveflow:hidden">
        
        <div style="border:1px solid green; font-size:20px; float:left;width:200px;"></div>
        <div style="border:1px solid blue; font-size:20px;float:left;width:200px"> Two </div>
        <div style="border:1px solid black; font-size:20px;float:right;width:200px"> Three </div>
        ...
        <!-- <div style="margin-left:2.25in; text-indent:.25in; margin: 0; "><b>
            ...
            <!-- <span style="font-size:11.0pt; font-family:Segoe UI Light;">(Section 32)</span>
            <span style="font-size:13.0pt;font-family:Segoe UI Light"></span>
        </div>
        <br>

        <div>
            <span style="margin-left:21.5em; font-size:12pt;font-family: Segoe UI Light;  ">
                <span style=" color: #191919" align="center">
                </span>Application for<span></span>
            </span>
        </div>

        <div>
            <span style=" font-size:18pt;font-family: Segoe UI Light; margin-left: 5em; ">
                <span style=" color: #191919">
                    <b>FOR INCORPORATION OF A COMPANY LIMITED BY GURANTEE </b><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                </span>
        </div>

        <div>
            <span style=" font-size:12pt;font-family: Segoe UI Light; margin-left: 16em; ">
                <span style=" color: #191919">
                    Section 4(1) of Companies Act No.
                    7 of 2007 (“the Act”)<span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                </span>
        </div> -->
        <br>
            ...
            <tbody>
                ...
                <tr>
                    <td width="25%"  class="bg-color">Registered Address<br>
                        <span style="font-size: 12px; padding:0px;"><I>(Physical Address in Sri Lnaka and must not be a PO Box
                                address)</I></span>
                    </td>
        ...
        <table style="border: 0;" width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td  width="93%" style="border: 0;font-size: 14px; ">
                        <ul>
            ...
            <tbody>
                <tr>
                    <td style="border: 0; color:  #212121;">
                        <b>
                            <u><br>INITIAL DIRECTORS</u>
                        </b>
                    </td>
                </tr>
                <tr>
                    <td style="border: 0; font-size: 14px; ">The following persons are the initial directors of
        ...
        <!-- <table style="border-color: #FFFFFF;" width="100%" height="20" >
            <tbody>
                ...
                <tr>
                    <td style="border: 0; font-size: 14px;">The following persons are the initial shareholders of the
                        proposed
                        company</td>
                </tr>
            </tbody>
