...
<body>
  <section class="form-body">
    ...
    <table width="100%" style="border:0; padding:0;">
            ...
            <tr>
              <td style="border:0;"><img width="100px" height="100px" src="{{asset('/form-images/govlogo.jpg')}}" alt="gov_logo"></td>
              <td style="border:0;">
                  <table style="padding:0; border:0;">
                      <tr style="padding:0; border:0;">
                          <td  style="padding-left:175px; font-size:16px; border:0; padding-bottom:20px;" height="50px;"><b>FORM 19</b></td>
                      ...
                      <tr>
                          <td  style="padding:0; font-size:14px; border:0; padding-bottom:3px;" colspan="2" align="center"  height="50px;"><b>CONSENT AND CERTIFICATE OF SECRETARY/ SECRETARIES</b></td>
                      </tr>
                      <tr>
              ...
              <td align="right" style="border:0;"><img width="130" height="auto" src="{{asset('/form-images/eroc.png')}}" alt="Logo EROC"></td>
            </tr>
        </table>
        <br>
      ...
      <table  width="100%" >
        <tbody>
          ...
          <tr>
            <td width="28%" height="60" class="bg-color" >Resedential Address </td>
      ...
      <table  width="100%" height="20">
        <tbody>
          <tr>
            <td width="28%" class="bg-color">Registration No.<br><span style="font-size:10px;">(if applicable)</span> </td>
            <td width="72%"></td>
          </tr>
        </tbody>
      </table>
      ...
      <table  width="100%">
        <tbody>
          <tr >
            <td width="28%" height="90" class="bg-color" >Signature</td>
            <td width="72%" height="90" >&nbsp;</td>
          </tr>
          <tr>
            <td width="28%" height="50" class="bg-color" >Full Name of Secretary </td>
            <td width="72%"  height="50"></td>
          </tr>
        </tbody>
      </table>
      ...
      <table  width="100%">
        <tbody>
          ...
          <tr >
            <td width="20%" height="60" class="bg-color">Address </td>
