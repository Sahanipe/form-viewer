  ...
  <style>
    ...
    <header class="form-header">  
        ...
        <table  width="100%">
            <tbody>
                <tr >
                    <td width="28%" height="90" class="bg-color" align="center">Signature of Director/Secretary*</td>
                    <td width="72%" height="90" >&nbsp;</td>
                </tr>
                <tr>
                    <td width="28%" height="50" class="bg-color" align="center">Full Name of Director/ Secretary*:</td>
                    <td width="72%"  height="50">&nbsp;</td>
                </tr>
            </tbody>
        </table>
        ...
        <table width="100%">
            <tbody>
                ...
                <tr>
                    <td width="28%" class="bg-color" style="padding-top:10px">Facsimile : </td>
                    <td width="72%">&nbsp;</td>
                </tr>
                <tr>
