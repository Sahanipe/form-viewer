...
<body>
  <section class="form-body">
    ...
    <table width="100%" style="border:0; padding:0;">
            ...
            <tr>
                <td colspan="4"  style="border:0; padding:0px; font-size:13px; padding-left:180px;">Section 221(2) of the Companies Act No.
                    7 of 2007</td>
            </tr>
        </table>
        <br>
      ...
      <table  width="100%" height="20">
        <tbody>
          <tr>
            <td width="28%" class="bg-color">Registration Number<br><span style="font-size:10px;">(if applicable)</span> </td>
            <td width="72%"></td>
          </tr>
        </tbody>
      </table>
      ...
      <table  width="100%">
        <tbody>
          <tr >
            <td width="28%" height="90" class="bg-color" align="center">Signature</td>
            <td width="72%" height="90" >&nbsp;</td>
          </tr>
          <tr>
            <td width="28%" height="50" class="bg-color" align="center">Full Name of Secretary </td>
            <td width="72%"  height="50"></td>
          </tr>
        </tbody>
      </table>
