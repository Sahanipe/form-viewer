...
<body>
    <section class="form-body">
        ...
        <table width="100%" style="border:0; padding:0;">
            <tr>
                <td width="20%" style="border:0; padding:0px;"><img width="100px" height="100px" src="{{  URL::to('/') }}/css/forms/govlogo.jpg" alt="gov_logo"></td>
                ...
                <td width="20%" style="border:0; padding:0px;"> <img width="130" height="auto" src="{{  URL::to('/') }}/css/forms/eroc.png" alt="Logo EROC"></td>
            </tr>
            <tr>
        ...
        <table style="border: 1" width="100%">
            <tbody>
                ...
                <tr style="border-bottom: 0;" >
                    ...
                    <td width="39.2%" height="0.5cm" rowspan="2">
                ...
                <tr style="border: 0;" >
                    <td width="3.3%" height="40" style="border-bottom: 0; border-top: 0;"></td>
       ...
       <br/>
        ...
        <table style="border:1;  border-left:0;" width="100%">
            <tbody>
