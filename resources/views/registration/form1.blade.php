        ...
        <!-- <header class="form-header"> -->
            <div style="margin-left:2.25in; text-indent:.25in; ">
                <span style="position:absolute;left:-1px;
                    ...
                    <img width="140" height="140" src="{{asset('/form-images/govlogo.jpg')}}" alt="gov_logo"></span>
                <span style="position: absolute; margin-left:534px; margin-top:30px; width:124px; ">
                    <img width="180" height="auto" src="{{asset('/form-images/eroc.png')}}" alt="Logo EROC"></span>
                </div>
...
<br>
            ...
            <table      width="100%" >
                <tbody>
                    <tr height="50">
                        <td width="28%" style="    font-size: 14pt;"> Company Number {{ $foo }}</td>
                        <td width="7%" >&nbsp;</td>
                        <td width="7%" >&nbsp;</td>
                        <td width="58%">&nbsp;</td>
                    </tr>
