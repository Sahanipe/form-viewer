                ...
                <tbody>
                    ...
                    <tr height="20">
                        ...
                        <td width="70%">
                         ...
                         <?php  echo $company_for_address->address1.','; ?>
                        <?php echo ($company_for_address->address2) ? $company_for_address->address2.',' : ''; ?>
            ...
            <table width="100%">
                <tbody>
                    <tr >
                        ...
                        <td width="70%" height="40" ><?php echo $loginUser->first_name; ?> <?php echo $loginUser->last_name; ?></td>
                    </tr>
                    <tr>
                        <td width="30%" class="bg-color">Email Address</td>
                        <td width="70%"><?php echo $loginUser->email; ?></td>
                    </tr>
                    <tr>
                        <td width="30%" class="bg-color">Telephone No. </td>
                        <td width="70%"><?php echo $loginUser->telephone; ?></td>
                    </tr>
                    <tr>
                        <td width="30%" class="bg-color" style="padding-top:10px">Mobile No. </td>
                        <td width="70%"><?php echo $loginUser->mobile; ?></td>
                    </tr>
                    <tr>
